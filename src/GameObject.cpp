...
char *GameObject::get_str() {
    return this->sprites->get_str();
}
...
bool GameObject::render() {
    ...
    //    return render_static(sprites->get_texture(), x, y);
    //} else if (strcmp(str, "sprites/boxtarget.png") == 0 ) {
    //    return render_animated(sprites->get_texture(), x, y, 200, 5, true);
    //} else if (strcmp(str, "sprites/free.png") == 0) {
    //    return render_permutated(sprites->get_texture(), x, y);
    //} else if (strcmp(str, "sprites/target.png") == 0) {
    //    return render_animated(sprites->get_texture(), x, y, 200, 5, false);
    //} else if (strcmp(str, "sprites/wall.png") == 0) {
    //    return render_with_variation(sprites->get_texture(), x, y, 6, 2);
    //} else {
    //    return render_static(sprites->get_texture(), x, y);
    //}
}
